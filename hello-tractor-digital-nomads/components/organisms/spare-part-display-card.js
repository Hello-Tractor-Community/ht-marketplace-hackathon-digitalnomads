...
export default function SparePartDisplayCard() {
    ...
    const sparePartId = '123';

    const handleViewDetails = () => {
        router.push(`/spareparts/${sparePartId}`);
    }
        ...
        <div className="bg-white w-72 hover:shadow-lg rounded-lg overflow-hidden hover:border hover:border-gray-200 mr-5 transform hover:scale-105 transition-transform duration-300">
            ...
            <div className="p-5">
                ...
                <div className="flex items-center space-x-4 text-sm mt-1">
                    <span className="text-red-500 font-semibold text-lg">$5.00</span>
                </div>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50">
                <button onClick={handleViewDetails} className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded-full text-sm font-semibold transition duration-300 ease-in-out transform hover:scale-105">
                    View Details
                </button>
            </div>
        </div>
